...
def selectMusic(): ### รับ Command มาจาก def SM1 ():
    ...
    Radiobutton(root,text="1. The Kid LAROI, Justin Bieber - STAY",variable=language, value=1,command=SendVariable).place(x=20, y=80)
    Radiobutton(root,text="2. LISA - BORN AGAIN feat. Doja Cat & RAYE)",variable=language, value=2,command=SendVariable).place(x=20, y=120)
    Radiobutton(root,text="3. John Martin - Anywhere For You",variable=language, value=3,command=SendVariable).place(x=20, y=160)
